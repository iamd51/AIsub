...
### Q: 字幕出現「作詞・作曲・編曲 初音ミク」等無關內容 🆕
A: **這是音樂檔案常見問題，v2.2+ 已提供完整解決方案**：

**預防措施**（推薦）：
1. 啟用「🎵 音樂模式」
2. 啟用「過濾重複」選項
3. 啟用「🧠 智能優化」功能
4. 使用較大的模型（medium/large）

**事後清理**：
1. 執行 `python clean_music_subtitles.py` 清理問題字幕
2. 或使用 `clean_subtitles.bat` 批量清理

**詳細說明**: 查看 `MUSIC_SUBTITLE_GUIDE.md`
